            ...
            <div className="row justify-content-center bg-light" >
                ...
                <form onSubmit={this.submitForm}>
                    <div className="form-group">
                        ...
                        <input type="email" className="form-control" name="email" value={this.state.email} onChange={this.onInpuntCheck} id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"/>
